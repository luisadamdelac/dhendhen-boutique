...
if (!function_exists('get_oriental_mindoro_barangays')) {
    ...
    function get_oriental_mindoro_barangays() {
        return array(
            ...
            'Baco' => array('Alag','Bangkatan','Baras','Bayanan','Burbuli','Catwiran I','Catwiran II','Dulangan I','Dulangan II','Lantuyang','Lumang Bayan','Malapad','Mangangan I','Mangangan II','Mayabig','Pambisan','Poblacion','Pulang-Tubig','Putican-Cabulo','San Andres','San Ignacio','Santa Cruz','Santa Rosa I','Santa Rosa II','Tabon-tabon','Tagumpay','Water'),
