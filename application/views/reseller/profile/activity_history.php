...
<div class="container-fluid py-4 fade-in">
    ...
    <div class="card ds-pink-table-card">
                        ...
                        <?php foreach ($logs as $log): ?>
                            <?php
                                ...
                                if (strpos($action, 'login') !== false) {
                                    ...
                                    $icon = 'fa-wallet'; $iconColor = '#2e7d32'; $iconBg = '#e8f5e9';
                                } elseif (strpos($action, 'order') !== false) {
                                    $icon = 'fa-shopping-cart'; $iconColor = '#f57f17'; $iconBg = '#fff8e1';
                                } elseif (strpos($action, 'listing') !== false || strpos($action, 'product') !== false || strpos($action, 'stock') !== false) {
                                    $icon = 'fa-boxes-stacked'; $iconColor = '#8b5cf6'; $iconBg = '#eee8ff';
        ...
        <div class="al-footer">
            ...
            <?php if ($pages > 1): ?>
                <div class="al-pager">
                    <a class="<?= $page <= 1 ? 'disabled' : ''; ?>" href="<?= site_url('reseller/profile/activity_history?page=' . max(1, $page - 1)); ?>">
                    ...
                    <?php for ($i = 1; $i <= $pages; $i++): ?>
                        ...
                        <?php else: ?>
                            <a href="<?= site_url('reseller/profile/activity_history?page=' . $i); ?>"><?= $i; ?></a>
                        <?php endif; ?>
                    <?php endfor; ?>
                    <a class="<?= $page >= $pages ? 'disabled' : ''; ?>" href="<?= site_url('reseller/profile/activity_history?page=' . min($pages, $page + 1)); ?>">
