<?php
/**
 * Customer Registration View — 3-step wizard (UI/UX only).
 ...
 * three visually-paginated sections (mirrors auth/register_reseller.php's
 * wizard pattern, minus the reseller-only Business Name field).
 */
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* ============ Layout shell ============ */
        .register-wrapper { width: 100%; max-width: 1120px; }
        ...
        .register-box { width: 100%; max-width: 440px; display: flex; flex-direction: column; }

        .register-box h2 { font-size: 26px; font-weight: 700; color: var(--ds-text); margin-bottom: 6px; }
        .register-subtitle { font-size: 13.5px; color: var(--ds-muted); margin-bottom: 14px; font-weight: 400; }
        ...
        .reseller-hint a { color: var(--ds-pink-dark); font-weight: 600; text-decoration: none; }
        .reseller-hint a:hover { text-decoration: underline; }
        ...
        .step-node.complete .step-circle { background: var(--ds-gradient); border-color: transparent; color: #fff; }
        .step-node.complete::after { background: var(--ds-violet); }
        .step-node.complete .step-label { color: var(--ds-text); }

        /* ---- Step content ---- */
        .wizard-step { display: none; }
        .wizard-step.active { display: block; animation: stepIn 300ms ease; }
        ...
        .strength-bars span { flex: 1; height: 5px; border-radius: 3px; background: var(--ds-border); transition: background 0.3s ease; }
        ...
        .checkbox-group input { width: 17px; height: 17px; cursor: pointer; flex-shrink: 0; margin-top: 2px; accent-color: var(--ds-pink); }
        ...
        .btn-primary { background: var(--ds-gradient); color: #fff; flex: 1; }
        ...
        .login-link { text-align: center; font-size: 13px; color: #666; margin-top: 8px; }
        ...
        <div class="register-right">
            <div class="register-box">
                ...
                <p class="reseller-hint">
                    Want to sell on DropSell?
                    <a href="<?php echo site_url('auth/register-reseller'); ?>">Apply as a Reseller</a> instead.
                </p>
                ...
                <form method="POST" action="<?php echo site_url('auth/do_register'); ?>" novalidate id="registerForm">
                    <?php echo csrf_field(); ?>
                    ...
                    <section class="wizard-step" data-step="2" aria-labelledby="step2Heading">
                        <div class="step-heading" id="step2Heading"><i class="fas fa-address-card"></i> Contact &amp; Address Information</div>
                        <p class="step-subtext">So we know where to send your orders.</p>
                    ...
                    <section class="wizard-step" data-step="3" aria-labelledby="step3Heading">
                        ...
                        <p class="step-subtext">Create a strong password to protect your account.</p>

                        <div class="form-group" data-field="password">
                            <label for="reg_password">Password <span class="required-tag">*</span></label>
                            <div class="input-group has-toggle no-left-icon">
                                <input type="password" name="password" id="reg_password" placeholder="Min. 12 characters" required autocomplete="new-password">
                                <button type="button" class="toggle-password" onclick="togglePwd('reg_password', this)" tabindex="-1" aria-label="Show password">
                        ...
                        <div class="form-group" data-field="password_confirm">
                            <label for="reg_password_confirm">Confirm Password <span class="required-tag">*</span></label>
                            <div class="input-group has-toggle no-left-icon">
                                <input type="password" name="password_confirm" id="reg_password_confirm" placeholder="••••••••" required autocomplete="new-password">
                                <button type="button" class="toggle-password" onclick="togglePwd('reg_password_confirm', this)" tabindex="-1" aria-label="Show password">
                                    <i class="fas fa-eye"></i>
                                </button>
                            </div>
...
<script>
    ...
    (function() {
        ...
        function evaluate() {
            ...
            validateStepField('reg_password');
            validateStepField('reg_password_confirm');
        }

        pwd.addEventListener('input', evaluate);

        var confirmPwd = document.getElementById('reg_password_confirm');
        if (confirmPwd) confirmPwd.addEventListener('input', function() { validateStepField('reg_password_confirm'); });
    })();
    ...
    (function() {
        ...
        var stepTitles = ['Personal Information', 'Contact & Address Information', 'Account Security'];
        var currentStep = 1;
        ...
        var validators = {
            ...
            password: function() {
                var v = document.getElementById('reg_password').value;
                return v.length >= 12 && /[A-Z]/.test(v) && /[a-z]/.test(v) && /[0-9]/.test(v) && /[!@#$%^&*]/.test(v);
            },
            password_confirm: function() {
                var v = document.getElementById('reg_password_confirm').value;
