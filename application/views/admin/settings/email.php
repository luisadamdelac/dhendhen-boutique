        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm" style="border-radius:12px;overflow:hidden;">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h3 class="card-title"><i class="fas fa-envelope"></i> Email Status</h3>
                    <a href="<?php echo site_url('admin/settings/email'); ?>" class="btn btn-sm btn-outline-secondary">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-6 col-md-2">
                            <div class="stat-card">
                                <div class="stat-icon" style="background:<?php echo $email_stats['smtp_enabled'] ? '#e8f5e9' : '#ffebee'; ?>;color:<?php echo $email_stats['smtp_enabled'] ? '#2e7d32' : '#c62828'; ?>;">
                                    <i class="fas fa-power-off"></i>
                                </div>
                                <div>
                                    <div class="stat-label">SMTP Enabled</div>
                                    <div class="stat-value" style="font-size:16px;"><?php echo $email_stats['smtp_enabled'] ? 'Yes' : 'No'; ?></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-2">
                            <div class="stat-card">
                                <div class="stat-icon" style="background:<?php echo $email_stats['configured'] ? '#e8f5e9' : '#fff3e0'; ?>;color:<?php echo $email_stats['configured'] ? '#2e7d32' : '#e65100'; ?>;">
                                    <i class="fas fa-plug"></i>
                                </div>
                                <div>
                                    <div class="stat-label">Configured</div>
                                    <div class="stat-value" style="font-size:16px;"><?php echo $email_stats['configured'] ? 'Yes' : 'No'; ?></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-2">
                            <div class="stat-card">
                                <div class="stat-icon" style="background:#eef0ff;color:#4361ee;"><i class="fas fa-clock"></i></div>
                                <div>
                                    <div class="stat-label">Pending</div>
                                    <div class="stat-value"><?php echo number_format($email_stats['pending'] ?? 0); ?></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-2">
                            <div class="stat-card">
                                ...
                                <div>
                                    ...
                                    <div class="stat-value"><?php echo number_format($email_stats['sent'] ?? 0); ?></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-2">
                            <div class="stat-card">
                                ...
                                <div>
                                    ...
                                    <div class="stat-value"><?php echo number_format($email_stats['failed'] ?? 0); ?></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-2">
                            <div class="stat-card">
                                <div class="stat-icon" style="background:#ede7f6;color:#5e35b1;"><i class="fas fa-history"></i></div>
                                <div>
                                    <div class="stat-label">Last Sent</div>
                                    <div class="stat-value" style="font-size:14px;"><?php echo !empty($email_stats['last_sent']) ? date('M d, g:i A', strtotime($email_stats['last_sent'])) : 'Never'; ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
