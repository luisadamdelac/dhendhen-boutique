...
<?php if ($branch_name): ?>
<div class="wk-layout">
    <div class="wk-main" style="min-width:0;">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title"><i class="fas fa-search"></i> Find Product</h3>
            </div>
            <div class="card-body">
                <div class="wk-search-wrap">
                    <i class="fas fa-search"></i>
                    <input type="text" id="wkSearchInput" placeholder="Search by product name or SKU..." autocomplete="off">
                </div>
    ...
    <div class="wk-side" style="min-width:0;">
        <div class="card">
            <div class="card-header">
                    ...
                    <?php foreach ($recent_sales as $sale): ?>
                        <div style="padding:10px 0; border-bottom:1px solid var(--border);">
                            ...
                            <div style="font-size:11.5px; color:var(--gray);">
                                <?php echo date('M j, Y g:i A', strtotime($sale['created_at'])); ?> &middot;
...
<script>
const WK_BRANCH_ID = <?php echo (int) ($branch_id ?? 0); ?>;
const WK_SEARCH_URL = '<?php echo site_url('staff/walkin/search_products'); ?>';
const WK_CREATE_URL = '<?php echo site_url('staff/walkin/create'); ?>';
...
function wkRunSearch(q) {
    ...
    fetch(WK_SEARCH_URL + '?q=' + encodeURIComponent(q))
        .then(r => r.json())
        .then(data => {
            if (!data.success) {
