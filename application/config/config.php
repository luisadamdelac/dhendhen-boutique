...
|
*/
// 'Authenticated_' is not a typo: CodeIgniter auto-requires
// application/core/{subclass_prefix}Controller.php as a CI_Controller
// extension on every request. This app's Authenticated_Controller.php
// relies on exactly that mechanism to be loaded, so don't "fix" this to
// the conventional 'MY_' without first moving that class elsewhere.
$config['subclass_prefix'] = 'Authenticated_';
...
|
*/
$config['encryption_key'] = '253252fbeec759a4fcc3ab641a795c7e2558e4f0709028207f58215c9280adc6';
